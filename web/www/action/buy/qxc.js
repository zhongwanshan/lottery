        ...
        methods: {
            ...
            setOrderInfo: function () {
                ...
                utility.setDigitalOrderInfo(self, self.buyInfo.lotteryTypeId, "七星彩", function (data, i) {
                    return self.resultList[i]["digitalBetType"] + "|" + self.resultList[i]["dBetFunction"] + "||" + self.resultList[i]["oneList"].join("") + "," + self.resultList[i]["twoList"].join("") + "," + self.resultList[i]["threeList"].join("") + "," + self.resultList[i]["fourList"].join("") + "," + self.resultList[i]["fiveList"].join("") + "," + self.resultList[i]["sixList"].join("") + "," + self.resultList[i]["sevenList"].join("") + "||";
                }, function () {
