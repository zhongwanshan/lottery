    ...
    var pageVue = new Vue({
        ...
        data: {
            ...
            paramInfo: {
                ...
                rechargePolicyId: "",
                remark: "",
                goToUrl: "/shop/view/user/depRech.html",
                action: CONFIG.ACTION.userRrecharge
            },
            remark: "",
            rechargePolicyList: []
        ...
        methods: {
            ...
            doRechargeAction: function () {
                ...
                self.rechargeInfo.backUrl = CONFIG.HOST + "/shop/view/order/result.html" + "?paramInfo=" + encodeURI(JSON.stringify(self.paramInfo));
